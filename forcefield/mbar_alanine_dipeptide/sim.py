...
n_steps_str  = sys.argv[4]
if len(sys.argv) > 5 and sys.argv[5] == "CutoffPeriodic":
...
forcefield = ForceField(ff_filepath, './data/implicit/gbn2.xml') #陰溶媒モデル
...
system = forcefield.createSystem(
    ...
    constraints=HBonds, #制約を入れることで速くなる
    hydrogenMass=2*amu,
